...
def init_mysql_db(db):
    """Initialise la base de données MySQL avec les tables nécessaires"""
    cursor = db.cursor()

    # Créer la base de données si elle n'existe pas
    cursor.execute("CREATE DATABASE IF NOT EXISTS gestion_enseignement CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci")
    cursor.execute("USE gestion_enseignement")
